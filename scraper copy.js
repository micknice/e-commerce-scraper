...
//         await page.goto(
//             "https://mirafit.co.uk/mirafit-m2-flat-weight-bench.html"
//         );

//         console.log("Page has been loaded!");

//         // Insert a 2000ms (2-second) delay before proceeding
...
//                 document.waitForSelector('//*[@id="maincontent"]/div[3]/div/div[1]/div[1]/div[1]/div[2]/div[3]/div[2]/div[1]/div[3]/div[1]')
...
const scrape = async () => {
    ...
    product.reviews = []
      while (true) {
        ...
        product.reviews.push(...scrapedData);
    
        const nextLink = await page.$('a.action.next[title="Next"]');
        if (nextLink) {
